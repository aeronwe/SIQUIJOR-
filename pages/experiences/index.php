                    ...
                    <div class="exp-card-content">
                        ...
                        <div class="exp-card-footer">
                            <?php if (is_numeric($exp['price'])): ?>
                                <span class="exp-card-price">₱<?= number_format($exp['price']) ?> <small>/ person</small></span>
                                <div class="exp-card-actions">
                                    <?php if (!empty($exp['page'])): ?>
                                        <a href="<?= htmlspecialchars($exp['page']) ?>" class="btn-exp-details">Details</a>
                                    <?php endif; ?>
                                    <a href="../booking/?experience=<?= urlencode($exp['id'] ?? '') ?>" class="btn-exp-book">Book Now &rarr;</a>
                                </div>
                            <?php else: ?>
                                <span class="exp-card-price" style="font-size: 0.88rem; color: var(--color-text-medium); font-weight: 500;">Custom Rates</span>
                                <div class="exp-card-actions">
                                    <?php if (!empty($exp['page'])): ?>
                                        <a href="<?= htmlspecialchars($exp['page']) ?>" class="btn-exp-details">Details</a>
                                    <?php endif; ?>
                                    <a href="../contact/" class="btn-exp-book">Contact Us &rarr;</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
